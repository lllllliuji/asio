...
class Service {
   ...
   private:
    ...
    void process_request() {
        // Read file.
        std::string resource_file_path = std::string("/home/liuji/http-root") + m_requested_resource;
...
const std::map<unsigned int, std::string> Service::http_status_table = {
    {200, "200 OK"},           {404, "404 Not Found"},       {413, "413 Request Entity Too Large"},
    {500, "500 Server Error"}, {501, "501 Not Implemented"}, {505, "505 HTTP Version Not Supported"}};
